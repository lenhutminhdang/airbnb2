...
export default function PerksCheckBox({ formData, onTogglePerk }) {
  const perks = {
    wifi: formData.perks.includes("wifi"),
    parking: formData.perks.includes("parking"),
    tv: formData.perks.includes("tv"),
    radio: formData.perks.includes("radio"),
    pets: formData.perks.includes("pets"),
    privateEntrance: formData.perks.includes("privateEntrance"),
  };

  return (
    <div>
      <h2 className="text-3xl md:text-2xl">Perks</h2>
